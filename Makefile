...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Jul 3 06:28:00 2014
# Project:  Ipm.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Ipm.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtOpenGL -I/usr/include/qt4 -IC:/Program\ Files/NVIDIA\ GPU\ Computing\ Toolkit/CUDA/v5.0/include -Ihome/ImageProject/libs/opencv-2.4.9/include -I/usr/X11R6/include -I.
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -L/usr/X11R6/lib -LC:/Program\ Files/NVIDIA\ GPU\ Computing\ Toolkit/CUDA/v5.0/lib/Win32 -lOpenCL -Lhome/ImageProject/libs/opencv-2.4.9/lib -lopencv_core -lopencv_imgproc -lopencv_highgui -lopencv_ml -lopencv_video -lopencv_features2d -lopencv_calib3d -lopencv_objdetect -lopencv_contrib -lopencv_legacy -lopencv_flann -lopencv_nonfree -lQtOpenGL -lQtGui -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = Ipm.cpp \
		...
		ui/SurfPanel.cpp moc_ImageViewer.cpp \
...
Makefile: Ipm.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
...
compiler_moc_header_make_all: moc_ImageViewer.cpp moc_NormalBlurPanel.cpp moc_GaussianBlurPanel.cpp moc_MedianBlurPanel.cpp moc_BilateralFilterPanel.cpp moc_ConvolutionFilterPanel.cpp moc_ErosionPanel.cpp moc_DilationPanel.cpp moc_MorphoExtPanel.cpp moc_ThresholdingPanel.cpp moc_SobelPanel.cpp moc_ScharrPanel.cpp moc_LaplacePanel.cpp moc_CannyPanel.cpp moc_SurfPanel.cpp
...
moc_NormalBlurPanel.cpp: ui/NormalBlurPanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/NormalBlurPanel.h -o moc_NormalBlurPanel.cpp

moc_GaussianBlurPanel.cpp: ui/GaussianBlurPanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/GaussianBlurPanel.h -o moc_GaussianBlurPanel.cpp

moc_MedianBlurPanel.cpp: ui/MedianBlurPanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/MedianBlurPanel.h -o moc_MedianBlurPanel.cpp

moc_BilateralFilterPanel.cpp: ui/BilateralFilterPanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/BilateralFilterPanel.h -o moc_BilateralFilterPanel.cpp

moc_ConvolutionFilterPanel.cpp: ui/ConvolutionFilterPanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/ConvolutionFilterPanel.h -o moc_ConvolutionFilterPanel.cpp

moc_ErosionPanel.cpp: ui/ErosionPanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/ErosionPanel.h -o moc_ErosionPanel.cpp

moc_DilationPanel.cpp: ui/DilationPanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/DilationPanel.h -o moc_DilationPanel.cpp

moc_MorphoExtPanel.cpp: ui/MorphoExtPanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/MorphoExtPanel.h -o moc_MorphoExtPanel.cpp

moc_ThresholdingPanel.cpp: ui/ThresholdingPanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/ThresholdingPanel.h -o moc_ThresholdingPanel.cpp

moc_SobelPanel.cpp: ui/SobelPanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/SobelPanel.h -o moc_SobelPanel.cpp

moc_ScharrPanel.cpp: ui/ScharrPanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/ScharrPanel.h -o moc_ScharrPanel.cpp

moc_LaplacePanel.cpp: ui/LaplacePanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/LaplacePanel.h -o moc_LaplacePanel.cpp

moc_CannyPanel.cpp: ui/CannyPanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/CannyPanel.h -o moc_CannyPanel.cpp

moc_SurfPanel.cpp: ui/SurfPanel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ui/SurfPanel.h -o moc_SurfPanel.cpp
...
qrc_Ipm.cpp: Ipm.qrc \
		...
		images/ip.ico \
		images/open.png
	/usr/bin/rcc -name Ipm Ipm.qrc -o qrc_Ipm.cpp
