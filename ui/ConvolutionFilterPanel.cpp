...
#include "ConvolutionFilterPanel.h"
...
void ConvolutionFilterPanel::on_sliKernelSize_valueChanged(int value){
	ImageViewer* parent = qobject_cast<ImageViewer *>(this->parentWidget());
	parent->convolutionFilterAction(value*2+1);
}


ConvolutionFilterPanel::ConvolutionFilterPanel(QWidget *parent)
     : QDialog(parent)
 {
	sliKernelSize = new QSlider(Qt::Horizontal, this);
	sliKernelSize->setRange(1,5);
