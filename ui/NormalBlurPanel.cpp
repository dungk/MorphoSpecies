...
#include "NormalBlurPanel.h"
#include "../ImageViewer.h"

namespace ui {

void NormalBlurPanel::on_sliKernelSize_valueChanged(int value){
	ImageViewer* parent = qobject_cast<ImageViewer *>(this->parentWidget());
	parent->normalBlurAction(value*2+1);
}


NormalBlurPanel::NormalBlurPanel(QWidget *parent)
     : QDialog(parent)
 {
