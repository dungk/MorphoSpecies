...
void DilationPanel::on_sliKernelSize_valueChanged(int value){
	ImageViewer* parent = qobject_cast<ImageViewer *>(this->parentWidget());
	parent->dilationAction(value*2+1,sliElement->value());
}
...
DilationPanel::DilationPanel(QWidget *parent)
     : QDialog(parent)
 {
