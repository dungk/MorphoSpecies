...
#ifndef CONVOLUTIONFILTERPANEL_H_
#define CONVOLUTIONFILTERPANEL_H_
...
class ConvolutionFilterPanel : public QDialog
{
    Q_OBJECT

public:
    static const int DF_KERNEL_SIZE=1;
    ConvolutionFilterPanel(QWidget *parent);
...
#endif /* CONVOLUTIONFILTERPANEL_H_ */
